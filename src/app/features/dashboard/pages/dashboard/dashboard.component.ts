  ...
  unitTypes: UnitType[] = [
    {
      ...
      description: 'Registra vehículos que llegan vacíos para cargar material o productos',
      icon: '📦',
    ...
    },
    {
      ...
      description: 'Registra vehículos que llegan con material o productos para descargar',
      icon: '🚛',
